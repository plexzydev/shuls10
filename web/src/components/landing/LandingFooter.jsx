      ...
      >
        <div className="max-w-[1100px] mx-auto px-6 pt-16 pb-10">
          ...
          <div className="flex justify-center mb-12">
            <h2
              className="font-heading font-black leading-none select-none px-8"
              style={{
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10 mb-12">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground leading-relaxed">
                Sistema de lealtad para la comunidad de Shuls en Kick.
                Mirá, chateá, acumulá.
              </p>
            </div>
            ...
            {/* Navigation */}
            <div>
              <h4 className="text-xs font-bold uppercase tracking-[0.15em] text-brand mb-4">
                NAVEGACIÓN
              </h4>
